      ...
      <main ref={mainScrollRef} className="flex-1 overflow-y-auto pb-[calc(74px+env(safe-area-inset-bottom))] md:pb-0 relative bg-background flex flex-col">
        ...
        <div className="flex-1 flex flex-col">
          <AnimatePresence mode="wait">
            <motion.div key={location.pathname} className="flex-1 relative z-0" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ ease: "easeInOut", duration: 0.25 }}>
              {outlet}
            </motion.div>
          </AnimatePresence>
        </div>
