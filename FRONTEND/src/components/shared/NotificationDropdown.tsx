...
export function NotificationDropdown({ onClose: _onClose, className }: { onClose?: () => void, className?: string }) {
  ...
  return (
    <motion.div
      ...
      className={cn("absolute w-[340px] rounded-[28px] shadow-[0_20px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_40px_100px_rgba(0,0,0,0.8)] overflow-hidden z-[9999] border bg-background/95 dark:bg-[#0B132B]/98 backdrop-blur-[60px] saturate-[1.2] border-border dark:border-white/[0.12] ring-1 ring-black/5 dark:ring-white/5", className)}>
