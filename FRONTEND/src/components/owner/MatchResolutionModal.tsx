    ...
    const handleConfirm = () => {
        ...
        setTimeout(() => {
            try {
                ...
                setError(e.message || "Failed to submit score. USAP rules require a win by 2 margin.");
            } finally {
                setIsSubmitting(false);
            }
        }, 400);
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                ...
                >
                    ...
                    <div className="p-6 flex flex-col gap-6">
                        ...
                        <div className={`grid grid-cols-[auto_1fr_1fr] gap-4 items-center ${isLocked ? 'opacity-50 pointer-events-none' : ''}`}>
                    ...
                    <div className="px-6 py-4 bg-muted/30 border-t border-border flex justify-between items-center">
                        ...
                        {!isEditMode && (
                            <button 
                                ...
                                className={`px-6 py-2 flex items-center justify-center min-w-[140px] gap-2 text-sm font-bold rounded-md shadow-md transition-all ${!isLocked ? 'bg-primary text-primary-foreground hover:opacity-90 hover:scale-[1.02] active:scale-[0.97]' : 'bg-muted text-muted-foreground cursor-not-allowed'}`}
                            >
                                {isSubmitting ? (
                                    <motion.div
                                        animate={{ rotate: 360 }}
