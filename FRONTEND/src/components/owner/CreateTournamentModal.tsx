...
function PremiumSelect({ value, onChange, options, labelMap }: { value: string | number, onChange: (val: any) => void, options: (string | number)[], labelMap?: Record<string | number, string> }) {
    const [isOpen, setIsOpen] = useState(false);
    return (
        <div className="relative">
            <button
