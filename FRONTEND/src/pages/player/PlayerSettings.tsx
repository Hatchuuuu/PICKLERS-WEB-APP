...
function Toggle({ checked, onChange }: { checked: boolean; onChange: () => void }) {
  return (
    <button
      onClick={onChange}
      className={`w-12 h-[28px] rounded-full flex items-center px-0.5 transition-colors duration-300 shrink-0 ${checked ? "bg-emerald-500" : "bg-white/10 border border-white/5"}`}
    >
      <motion.div
        className="w-[24px] h-[24px] rounded-full bg-white shadow-[0_2px_4px_rgba(0,0,0,0.3)]"
...
export function PlayerSettingsTab() {
  ...
  return (
    <div className="min-h-full pb-20 pt-4 px-4 max-w-xl mx-auto w-full">
      ...
      {user?.role === "owner" ? (
        <div className="rounded-[20px] p-5 mb-8 relative overflow-hidden group cursor-pointer"
          ...
          <div className="flex items-center gap-4 relative z-10">
            ...
            <div className="flex-1">
              <div className="text-[17px] font-bold text-white mb-0.5">Owner Access Verified</div>
              <div className="text-[13px] text-white/50">Tap to open dashboard</div>
            </div>
        ...
        <div className="rounded-[20px] p-5 mb-8 relative overflow-hidden cursor-pointer"
          ...
          <div className="flex items-center gap-4 relative z-10">
            ...
            <div className="flex-1">
              <div className="text-[15px] font-bold text-white mb-0.5">Own a court?</div>
              <div className="text-[13px] text-white/50">Apply to list your facility</div>
            </div>
            <ChevronRight className="w-5 h-5 text-white/30" />
          </div>
        </div>
      ...
      {/* Profile Section */}
      <div className="mb-8">
        <h3 className="text-[12px] font-bold text-white/40 uppercase tracking-widest mb-2 px-4">Profile</h3>
        <div className="rounded-[16px] overflow-hidden" style={{ background: "var(--surface-raised)" }}>
          
          <button onClick={() => handleEditClick("profile", "name", "Full Name", profile.name)} className="w-full flex items-center justify-between px-4 py-3.5 hover:bg-white/5 transition-colors">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[15px] text-white/50">{profile.name}</span>
              <ChevronRight className="w-4 h-4 text-white/20" />
            </div>
          </button>
          
          <div className="h-px w-full bg-white/5 ml-14" />
          
          <button onClick={() => handleEditClick("profile", "email", "Email Address", profile.email)} className="w-full flex items-center justify-between px-4 py-3.5 hover:bg-white/5 transition-colors">
            <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[15px] text-white/50">{profile.email}</span>
              <ChevronRight className="w-4 h-4 text-white/20" />
            </div>
          </button>
          ...
          <button onClick={() => handleEditClick("profile", "phone", "Phone Number", profile.phone)} className="w-full flex items-center justify-between px-4 py-3.5 hover:bg-white/5 transition-colors">
            <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[15px] text-white/50">{profile.phone}</span>
              <ChevronRight className="w-4 h-4 text-white/20" />
            </div>
          </button>
          ...
          <button onClick={() => handleEditClick("profile", "skill", "Skill Level", profile.skill)} className="w-full flex items-center justify-between px-4 py-3.5 hover:bg-white/5 transition-colors">
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 rounded-md flex items-center justify-center bg-purple-500">
                <Trophy className="w-4 h-4 text-white" />
              </div>
              <span className="text-[16px] text-white">Skill Level</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-[15px] text-white/50">{profile.skill}</span>
              <ChevronRight className="w-4 h-4 text-white/20" />
            </div>
          </button>
      ...
      <div className="mb-8">
        <h3 className="text-[12px] font-bold text-white/40 uppercase tracking-widest mb-2 px-4">Notifications</h3>
        <div className="rounded-[16px] overflow-hidden" style={{ background: "var(--surface-raised)" }}>
          ...
          <div className="w-full flex items-center justify-between px-4 py-3.5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[16px] text-white">Booking Confirmations</span>
            </div>
          ...
          <div className="w-full flex items-center justify-between px-4 py-3.5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[16px] text-white">Open Match Alerts</span>
            </div>
          ...
          <div className="w-full flex items-center justify-between px-4 py-3.5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[16px] text-white">Community Updates</span>
            </div>
      ...
      <div className="mb-8">
        <h3 className="text-[12px] font-bold text-white/40 uppercase tracking-widest mb-2 px-4">Payment Methods</h3>
        <div className="rounded-[16px] overflow-hidden" style={{ background: "var(--surface-raised)" }}>
          
          <button onClick={() => handleEditClick("payment", "gcash", "GCash Number", payments.gcash)} className="w-full flex items-center justify-between px-4 py-3.5 hover:bg-white/5 transition-colors">
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 rounded-md flex items-center justify-center" style={{ background: "#0055FE" }}>
                <CreditCard className="w-4 h-4 text-white" />
              </div>
              <span className="text-[16px] text-white">GCash</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-[15px] text-white/50">{payments.gcash}</span>
              <ChevronRight className="w-4 h-4 text-white/20" />
            </div>
          </button>
          ...
          <button onClick={() => handleEditClick("payment", "cash", "Cash Preference", payments.cash)} className="w-full flex items-center justify-between px-4 py-3.5 hover:bg-white/5 transition-colors">
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 rounded-md flex items-center justify-center bg-emerald-600">
                <Banknote className="w-4 h-4 text-white" />
              </div>
              <span className="text-[16px] text-white">Cash on Site</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-[15px] text-white/50">{payments.cash}</span>
              <ChevronRight className="w-4 h-4 text-white/20" />
            </div>
          </button>
          ...
          <button onClick={() => handleEditClick("payment", "credits", "Pickle Credits", payments.credits)} className="w-full flex items-center justify-between px-4 py-3.5 hover:bg-white/5 transition-colors">
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 rounded-md flex items-center justify-center bg-yellow-500">
                <Coins className="w-4 h-4 text-white" />
              </div>
              <span className="text-[16px] text-white">Pickle Credits</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-[15px] text-white/50">{payments.credits}</span>
              <ChevronRight className="w-4 h-4 text-white/20" />
            </div>
          </button>
      ...
      <div className="mb-8">
        <button 
          ...
          className="w-full flex items-center justify-center gap-2 py-4 rounded-[16px] text-[17px] font-normal text-[#FF453A] hover:bg-white/5 transition-colors"
          style={{ background: "var(--surface-raised)" }}>
      ...
      {user?.verificationStatus === "pending" && (
        <div className="mb-8">
          ...
          <div className="rounded-[16px] overflow-hidden" style={{ background: "rgba(239, 68, 68, 0.05)", border: "1px dashed rgba(239, 68, 68, 0.2)" }}>
            <button onClick={() => verifyAccount()} className="w-full flex items-center justify-between px-4 py-3.5 hover:bg-white/5 transition-colors text-left">
              <div>
        ...
        {editingField && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.95, opacity: 0, y: 20 }}
              ...
              style={{ background: "rgba(28,28,30,0.9)", border: "1px solid rgba(255,255,255,0.1)", boxShadow: "0 20px 40px rgba(0,0,0,0.5)" }}>
              
              <div className="px-6 pt-6 pb-4">
                <h2 className="text-[20px] font-bold text-white mb-1" >Edit {editingField.label}</h2>
                <p className="text-[13px] text-white/50 mb-4">Update your profile information.</p>
              ...
              <div className="flex border-t border-white/5">
                <button onClick={() => setEditingField(null)}
                  className="flex-1 py-4 text-[16px] font-medium text-white/60 hover:bg-white/5 transition-colors">
                  Cancel
                </button>
                <div className="w-px bg-white/5" />
                <button onClick={saveEdit}
                  className="flex-1 py-4 text-[16px] font-bold text-blue-500 hover:bg-white/5 transition-colors">
                  Save
                </button>
              </div>
            </motion.div>
