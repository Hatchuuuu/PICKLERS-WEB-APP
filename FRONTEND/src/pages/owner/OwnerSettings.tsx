          ...
          <SettingsGroup title="Facility Identity">
            <div className="p-5">
              ...
              <div className="space-y-4">
                <div>
                  <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest mb-2 block">Facility Name</label>
                ...
                <div>
                  <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest mb-2 block">Location</label>
        ...
        <div className="flex flex-col">
                ...
                >
                  <div className="p-4 grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-2">
                      <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest">Opening Time</label>
                      <TimePicker value={openTime} onChange={setOpenTime} />
                    </div>
                    <div className="flex flex-col gap-2">
                      <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest">Closing Time</label>
          ...
          <SettingsGroup title="Payment Methods">
              ...
              {gcashEnabled && (
                ...
                >
                  <div className="p-4 flex flex-col gap-3">
                    <div className="relative">
                      <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest mb-1.5 block">GCash Number</label>
            ...
            <div className="flex items-center justify-between p-4">
              ...
              <div className="px-3 py-1.5 rounded-[8px] bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-[11px] font-bold uppercase tracking-widest">
                Active
              </div>
            </div>
          </SettingsGroup>
