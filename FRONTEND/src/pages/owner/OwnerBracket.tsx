      ...
      <div className="flex flex-col h-[100dvh] sm:h-screen overflow-hidden bg-background text-foreground font-sans">
        ...
        <header className="flex items-center justify-between gap-3 px-4 sm:px-6 py-3 border-b border-border shrink-0">
          ...
          <div className="flex items-center gap-3 min-w-0">
            <button
              onClick={() => navigate('/app/owner/tournaments')}
            ...
            <span className="px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest text-emerald-400 bg-emerald-400/10 border border-emerald-400/20 rounded-full shrink-0">
              Active
            </span>
          </div>
