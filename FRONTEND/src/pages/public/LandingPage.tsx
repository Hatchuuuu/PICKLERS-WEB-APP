...
import { 
  ...
  Star, ShieldCheck, CreditCard, Zap, Users, MapPin, Trophy
} from "lucide-react";
...
export function LandingPage() {
  ...
  const navBackground = useTransform(scrollY, [0, 100], ["rgba(10, 22, 40, 0)", "rgba(10, 22, 40, 0.92)"]);
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-accent-primary/20">
      ...
      <AnimatePresence>
        {mobileMenu && (
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }}
            className="fixed top-[60px] left-0 right-0 z-40 p-4"
            style={{ background: "rgba(10,22,40,0.98)", borderBottom: "1px solid var(--border-subtle)", backdropFilter: "blur(20px)" }}>
        ...
        <motion.div initial={{ opacity: 0, y: 32 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.23, 1, 0.32, 1] }} className="relative z-10 w-full max-w-4xl mx-auto">
          <div className="relative inline-flex items-center justify-center mb-8 group">
            ...
            <div className="relative inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[13px] font-medium w-full h-full"
              style={{
                background: "rgba(255, 255, 255, 0.03)", // Very subtle light tint for glass
                backdropFilter: "blur(12px)", // True static glassmorphism
                WebkitBackdropFilter: "blur(12px)",
                color: "var(--accent-primary)",
                border: "1px solid rgba(255, 255, 255, 0.05)" // Subtle static glass edge
              }}>
          ...
          <h1 className="text-6xl sm:text-7xl md:text-[100px] lg:text-[120px] leading-[0.95] tracking-[-0.03em] mb-[10px] flex justify-center"
          ...
          <div className="text-xl sm:text-2xl font-semibold tracking-[0.1em] mb-8 flex items-center justify-center gap-1.5"
            style={{ color: "var(--ink-primary)" }}>
            <span>FIND</span>
            <span className="text-[0.9em] mb-0.5 opacity-70">•</span>
            <span>BOOK</span>
            <span className="text-[0.9em] mb-0.5 opacity-70">•</span>
            <span>PLAY</span>
          </div>
          ...
          <div className="flex flex-row items-center justify-center gap-2 sm:gap-4 mb-8 w-full max-w-xl mx-auto px-2">
            <button onClick={() => navigate("/auth?intent=book")}
              ...
              style={{ background: "var(--accent-primary)", color: "#ffffff", boxShadow: "0 8px 32px -8px rgba(0, 217, 139, 0.5)" }}>
              <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out" />
              <div className="absolute top-0 -left-[100%] w-[50%] h-full bg-gradient-to-r from-transparent via-white/90 to-transparent skew-x-[-20deg]" style={{ animation: "button-shine 8s ease infinite" }} />
          ...
          <button onClick={() => navigate("/auth?intent=owner")}
            className="group flex items-center gap-3 pr-5 pl-2 py-2 rounded-full mx-auto transition-all hover:bg-white/5 active:scale-95 mt-2"
            style={{
            ...
            <div className="flex items-center gap-1.5 text-[14px] font-medium tracking-tight">
              <span style={{ color: "var(--ink-primary)" }}>Are you a Court Owner?</span>
              <span style={{ color: "var(--accent-primary)" }}>List your court</span>
            </div>
            <ArrowRight className="w-4 h-4 ml-0.5 opacity-80 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all" style={{ color: "var(--accent-primary)" }} />
          </button>
        </motion.div>
      </section>

      {/* Trusted Partners Marquee */}
      <section className="py-8 md:py-10 border-y border-solid overflow-hidden flex flex-col items-center relative z-10" style={{ borderColor: "rgba(255,255,255,0.03)", background: "var(--surface-base)" }}>
        <p className="text-[10px] md:text-[11px] font-bold tracking-[0.2em] uppercase mb-6 md:mb-8 text-white/40">Trusted by top clubs & facilities</p>
        <div className="flex w-full max-w-[2000px] overflow-hidden" style={{ maskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)", WebkitMaskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)" }}>
          <div className="flex animate-marquee min-w-max items-center gap-16 md:gap-24 px-8">
            {[1, 2, 3].map((set) => (
              <div key={set} className="flex items-center gap-16 md:gap-24">
                <div className="flex items-center gap-2.5 text-white/30 font-bold text-lg md:text-xl tracking-tight"><div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/5 flex items-center justify-center"><Trophy className="w-4 h-4 md:w-5 md:h-5"/></div> DUPR</div>
                <div className="flex items-center gap-2.5 text-white/30 font-bold text-lg md:text-xl tracking-tight"><div className="w-8 h-8 md:w-10 md:h-10 rounded-xl bg-white/5 flex items-center justify-center"><MapPin className="w-4 h-4 md:w-5 md:h-5"/></div> Manila Polo Club</div>
                <div className="flex items-center gap-2.5 text-white/30 font-bold text-lg md:text-xl tracking-tight"><div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/5 flex items-center justify-center"><ShieldCheck className="w-4 h-4 md:w-5 md:h-5"/></div> PPA Tour</div>
                <div className="flex items-center gap-2.5 text-white/30 font-bold text-lg md:text-xl tracking-tight"><div className="w-8 h-8 md:w-10 md:h-10 rounded-xl bg-white/5 flex items-center justify-center"><Building className="w-4 h-4 md:w-5 md:h-5"/></div> The Picklerry</div>
                <div className="flex items-center gap-2.5 text-white/30 font-bold text-lg md:text-xl tracking-tight"><div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/5 flex items-center justify-center"><Zap className="w-4 h-4 md:w-5 md:h-5"/></div> Joola</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-6">
              ...
              <div className="flex flex-col items-center justify-center text-center p-6 md:p-8 rounded-2xl relative overflow-hidden group"
                ...
                <div className="text-3xl md:text-[34px] leading-none font-bold tracking-tight mb-2.5"
                  style={{ fontFamily: "'Montserrat', sans-serif", WebkitFontSmoothing: "antialiased", color: "#ffffff", textShadow: "0 2px 10px rgba(0,0,0,0.2)" }}>
                  <CountUp from={0} to={142} duration={2} />+
                </div>
                <div className="text-[11px] font-bold tracking-[0.15em] uppercase" style={{ fontFamily: "'Montserrat', sans-serif", color: "rgba(255,255,255,0.6)" }}>Venues</div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center text-center p-6 md:p-8 rounded-2xl relative overflow-hidden group"
                ...
                <div className="text-[11px] font-bold tracking-[0.15em] uppercase" style={{ fontFamily: "'Montserrat', sans-serif", color: "rgba(255,255,255,0.6)" }}>Players</div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center text-center p-6 md:p-8 rounded-2xl relative overflow-hidden group"
                ...
                <div className="text-3xl md:text-[34px] leading-none font-bold tracking-tight mb-2.5 flex items-center justify-center gap-1"
                  style={{ fontFamily: "'Montserrat', sans-serif", WebkitFontSmoothing: "antialiased", color: "#ffffff", textShadow: "0 2px 10px rgba(0,0,0,0.2)" }}>
                  <CountUp from={0} to={5} duration={1.5} />–<CountUp from={0} to={10} duration={1.5} />%
                </div>
                <div className="text-[11px] font-bold tracking-[0.15em] uppercase" style={{ fontFamily: "'Montserrat', sans-serif", color: "rgba(255,255,255,0.6)" }}>Service Fee</div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center text-center p-6 md:p-8 rounded-2xl relative overflow-hidden group"
                ...
                <div className="text-3xl md:text-[34px] leading-none font-bold tracking-tight mb-2.5 flex items-baseline justify-center gap-1"
                  style={{ fontFamily: "'Montserrat', sans-serif", WebkitFontSmoothing: "antialiased", color: "#ffffff", textShadow: "0 2px 10px rgba(0,0,0,0.2)" }}>
                  <CountUp from={0} to={200} duration={2} /><span className="text-[18px] md:text-[22px] font-medium text-white/40">/day</span>
                </div>
                <div className="text-[11px] font-bold tracking-[0.15em] uppercase" style={{ fontFamily: "'Montserrat', sans-serif", color: "rgba(255,255,255,0.6)" }}>Signups</div>
              </div>
            ...
            {(["facilities", "open-play"] as const).map((val, idx) => (
              <button key={val} onClick={() => handleToggle(val)}
                ...
                style={{
                  ...
                  color: toggle === val ? "#ffffff" : "rgba(255, 255, 255, 0.5)",
              ...
              <div className={toggle === "facilities" ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" : "grid grid-cols-1 md:grid-cols-2 gap-5"}>
                {[1, 2, 3, 4, 5, 6].slice(0, toggle === "facilities" ? 6 : 4).map(i => (
                  <div key={i} className={`rounded-[28px] overflow-hidden relative ${toggle === "facilities" ? "h-[380px]" : "h-[160px]"}`} 
                    style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)", boxShadow: "0 8px 32px -8px rgba(0,0,0,0.3)" }}>
      ...
      {/* Bento Box Features */}
      <section className="px-6 py-24 max-w-6xl mx-auto border-t border-solid relative z-10" style={{ borderColor: "rgba(255,255,255,0.03)" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[280px]">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.98, y: 20 }} whileInView={{ opacity: 1, scale: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, ease: [0.23, 1, 0.32, 1] }}
            className="md:col-span-2 rounded-[32px] p-8 md:p-10 relative overflow-hidden group flex flex-col justify-end"
            style={{ background: "linear-gradient(145deg, rgba(255,255,255,0.04) 0%, rgba(255,255,255,0.01) 100%)", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 16px 40px -12px rgba(0,0,0,0.5)" }}>
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-3 tracking-tight">Skill-Based Matchmaking</h3>
              <p className="text-white/60 max-w-md leading-relaxed text-[15px] md:text-[16px]">Integrated with DUPR and self-rating systems to ensure you're always playing competitive, fun matches at your exact level.</p>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.98, y: 20 }} whileInView={{ opacity: 1, scale: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1, ease: [0.23, 1, 0.32, 1] }}
            className="rounded-[32px] p-8 relative overflow-hidden group flex flex-col justify-end"
            style={{ background: "linear-gradient(145deg, rgba(255,255,255,0.04) 0%, rgba(255,255,255,0.01) 100%)", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 16px 40px -12px rgba(0,0,0,0.5)" }}>
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-white mb-2 tracking-tight">Split Payments</h3>
              <p className="text-white/60 leading-relaxed text-[14px] md:text-[15px]">No more chasing friends for Venmo. Split court costs instantly.</p>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.98, y: 20 }} whileInView={{ opacity: 1, scale: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2, ease: [0.23, 1, 0.32, 1] }}
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-white mb-2 tracking-tight">Instant Booking</h3>
              <p className="text-white/60 leading-relaxed text-[14px] md:text-[15px]">Live availability sync. Secure a court in under 15 seconds flat.</p>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.98, y: 20 }} whileInView={{ opacity: 1, scale: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.3, ease: [0.23, 1, 0.32, 1] }}
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-3 tracking-tight">Vibrant Community</h3>
              <p className="text-white/60 max-w-md leading-relaxed text-[15px] md:text-[16px]">Join clubs, climb local leaderboards, chat with players, and get notified when your favorite group hosts an open play.</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      {/* Testimonials */}
      <section className="px-6 py-24 border-t border-solid relative overflow-hidden z-10" style={{ borderColor: "rgba(255,255,255,0.03)" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={i}
                ...
                className="rounded-[32px] p-8 relative group cursor-default transition-all duration-300 hover:scale-[1.02]"
                style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)", boxShadow: "0 16px 32px -12px rgba(0,0,0,0.5)" }}>
                <div className="flex items-center gap-1 mb-6">
                  {[...Array(t.rating)].map((_, j) => <Star key={j} className="w-4 h-4 fill-emerald-500 text-emerald-500" />)}
                </div>
                <p className="text-[16px] leading-relaxed mb-8 text-white/80 font-medium">"{t.text}"</p>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-bold text-[15px] text-white tracking-tight">{t.name}</div>
                    <div className="text-[13px] text-white/40 font-medium mt-0.5">{t.role}</div>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section className="px-6 py-24 border-t border-solid relative" style={{ borderColor: "rgba(255,255,255,0.05)", background: "linear-gradient(180deg, var(--background) 0%, rgba(10,22,40,0.5) 100%)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 relative">
            ...
            {[
              ...
              >
                <div className="w-24 h-24 mb-6 rounded-3xl flex items-center justify-center relative transition-transform duration-300 group-hover:scale-105 group-hover:-translate-y-1"
                  style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 8px 32px -8px rgba(0,0,0,0.5)" }}>
      ...
      {/* FAQ Section */}
      <section className="px-6 py-24 border-t border-solid" style={{ borderColor: "rgba(255,255,255,0.03)" }}>
            ...
            {[
              ...
              >
                <div className="px-6 py-5 flex items-center justify-between">
                  <h4 className="text-base font-semibold tracking-tight pr-4" style={{ color: openFaq === i ? "#fff" : "var(--ink-secondary)" }}>
                    {faq.q}
                  </h4>
                  <motion.div 
