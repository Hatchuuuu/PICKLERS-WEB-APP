        ...
        <motion.div initial={{ opacity: 0, y: 32 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.23, 1, 0.32, 1] }} className="relative z-10 w-full max-w-4xl mx-auto">
          ...
          <div className="flex flex-row items-center justify-center gap-2 sm:gap-4 mb-8 w-full max-w-xl mx-auto px-2">
            <button onClick={() => navigate("/auth?intent=book")}
              ...
              <div className="absolute top-0 -left-[100%] w-[50%] h-full bg-gradient-to-r from-transparent via-white/90 to-transparent skew-x-[-20deg]" style={{ animation: "button-shine 5s ease infinite", animationDelay: "0s" }} />
            ...
            <button onClick={() => navigate("/auth?intent=open-play")}
              ...
              <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out" />
              <div className="absolute top-0 -left-[100%] w-[50%] h-full bg-gradient-to-r from-transparent via-white/90 to-transparent skew-x-[-20deg]" style={{ animation: "button-shine 5s ease infinite", animationDelay: "0.4s" }} />
          ...
          <button onClick={() => navigate("/auth?intent=owner")}
            ...
            <div className="absolute top-0 -left-[100%] w-[50%] h-full bg-gradient-to-r from-transparent via-white/15 to-transparent skew-x-[-20deg]" style={{ animation: "button-shine 5s ease infinite", animationDelay: "0.8s" }} />
