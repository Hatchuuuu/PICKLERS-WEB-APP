                  ...
                  <>
                    <div className="group">
                      ...
                      <motion.div animate={isShaking && emailError ? { x: [-5, 5, -5, 5, 0] } : {}} transition={{ duration: 0.4 }} className="relative">
                        ...
                        <input type="email" value={email} onChange={e => { setEmail(e.target.value); if (emailError) validateEmail(e.target.value); }} placeholder="you@example.com" className={cn(`${inputClassName} pl-12 text-ellipsis`, emailError && "border-accent-danger text-accent-danger")} style={tab === "signup" ? { ...inputStyle, paddingRight: "140px" } : inputStyle}
                          onFocus={e => (e.currentTarget.style.borderColor = "var(--border-emphasis)")}
                  ...
                  <>
                    <div className="group">
                      ...
                      <div className="relative">
                        ...
                        <input type="tel" placeholder="+63 912 345 6789" className={`${inputClassName} pl-12 text-ellipsis`} style={tab === "signup" ? { ...inputStyle, paddingRight: "140px" } : inputStyle}
