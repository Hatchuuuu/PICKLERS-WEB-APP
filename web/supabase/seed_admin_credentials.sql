-- =====================================================================
-- PICKLERS — SEED ADMIN & DEMO ACCOUNTS
...
BEGIN
  -- 1. Create or ensure Super Admin account in auth.users
  ...
  VALUES (
    ...
    '$2a$10$e.x/J9.V6Yl5aJz5c4/Bf.8w0d.OaXN.aJ0/5w3a.3/4/5', -- Mock password hash
    NOW(),
    'authenticated',
    'authenticated',
    NOW(),
  ...
  -- 2. Create or ensure Super Admin profile in player_profiles
  ...
  -- 3. Create or ensure Demo Player account in auth.users
  INSERT INTO auth.users (
    id, instance_id, email, raw_user_meta_data, encrypted_password,
    email_confirmed_at, role, aud, created_at, updated_at
  )
  ...
  -- 4. Create or ensure Demo Player profile in player_profiles
  INSERT INTO public.player_profiles (
