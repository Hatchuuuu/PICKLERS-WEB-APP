...
BEGIN
  ...
  VALUES
    ('Saturday Morning Doubles',    'Doubles','open', (CURRENT_DATE+7)::text,  '08:00 AM','Metro Smashers Hub',     250,'3.5 – 4.0',2, 4,  'Metro Smashers Hub',    'Court 1',jsonb_build_array(jsonb_build_object('id',mock_u1::text,'name','Alex Johnson',  'level','3.5','avatar','')),mock_u1,   true,false),
    ('Beginners Open Play',         'Doubles','open', (CURRENT_DATE+8)::text,  '10:00 AM','Green Valley Courts',    150,'2.0 – 2.5',3, 8,  'Green Valley Courts',   'Court 2',jsonb_build_array(jsonb_build_object('id',mock_u3::text,'name','Michael Chen', 'level','3.0','avatar','')),mock_u3,   true,false),
    ('Competitive Singles Ladder',  'Singles','open', (CURRENT_DATE+10)::text, '06:00 PM','Elite Pickleball Center',300,'4.0+',     1, 8,  'Elite Pickleball Center','Court 1',jsonb_build_array(jsonb_build_object('id',mock_u2::text,'name','Sarah Williams','level','4.0','avatar','')),mock_u2,   true,false),
    ('After-work Dink Session',     'Doubles','full', (CURRENT_DATE+3)::text,  '07:00 PM','Ortigas Paddle Club',    200,'All Levels',4, 4,  'Ortigas Paddle Club',   'Court 4',jsonb_build_array(jsonb_build_object('id',mock_u4::text,'name','Jessica Davis','level','4.5','avatar','')),mock_u4,   true,false),
    ('BGC Night Smash',             'Doubles','open', (CURRENT_DATE+5)::text,  '09:00 PM','Metro Smashers Hub',     400,'3.5 – 4.5',2, 12, 'Metro Smashers Hub',    'Court 2',jsonb_build_array(jsonb_build_object('id',mock_u1::text,'name','Alex Johnson',  'level','3.5','avatar','')),mock_u1,   true,false),
    ('Mixed Doubles Tournament Prep','Doubles','open',(CURRENT_DATE+12)::text, '07:30 AM','The Dink Lounge',        350,'3.0 – 3.5',3, 8,  'The Dink Lounge',       'Court 1',jsonb_build_array(jsonb_build_object('id',mock_u5::text,'name','Marco Reyes',  'level','2.5','avatar','')),mock_u5,   true,false),
    ('Pro Level 5.0+ Clinic',       'Singles','open', (CURRENT_DATE+14)::text, '05:00 PM','Elite Pickleball Center',600,'5.0+',     1, 6,  'Elite Pickleball Center','Court 3',jsonb_build_array(jsonb_build_object('id',mock_u6::text,'name','Nina Santos',  'level','5.0','avatar','')),mock_u6,   true,false),
    ('Bayview Sunset Social',       'Doubles','open', (CURRENT_DATE+6)::text,  '05:30 PM','Bayview Pickleball',     200,'All Levels',2, 16, 'Bayview Pickleball',    'Court 1',jsonb_build_array(jsonb_build_object('id',mock_u2::text,'name','Sarah Williams','level','4.0','avatar','')),mock_u2,   true,false),
    ('Weekend Warriors Open',       'Doubles','open', (CURRENT_DATE+9)::text,  '09:00 AM','Southside Smash',        180,'2.5 – 3.0',4, 8,  'Southside Smash',       'Court 2',jsonb_build_array(jsonb_build_object('id',mock_u3::text,'name','Michael Chen', 'level','3.0','avatar','')),mock_u3,   true,false),
    ('Lunchtime Quick Smash',       'Doubles','open', (CURRENT_DATE+4)::text,  '12:00 PM','Riverfront Courts',      150,'All Levels',1, 4,  'Riverfront Courts',     'Court 1',jsonb_build_array(jsonb_build_object('id',mock_u4::text,'name','Jessica Davis','level','4.5','avatar','')),mock_u4,   true,false),
    ('Sunrise Rally Fitness',       'Singles','open', (CURRENT_DATE+11)::text, '06:00 AM','Sunrise Pickle Club',    100,'2.0 – 3.0',0, 4,  'Sunrise Pickle Club',   'Court 3','[]'::jsonb,                                                                                                mock_u5,   true,false),
    ('San Juan Friday Night',       'Doubles','open', (CURRENT_DATE+13)::text, '08:00 PM','San Juan Dinkers',       300,'3.5+',     2, 8,  'San Juan Dinkers',      'Court 1',jsonb_build_array(jsonb_build_object('id',mock_u6::text,'name','Nina Santos',  'level','5.0','avatar','')),mock_u6,   true,false);
