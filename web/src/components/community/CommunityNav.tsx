...
import { Users, MessageCircle, Activity, User } from "lucide-react";

export type Tab = "feed" | "messages" | "community" | "profile";
      ...
      {tabs.map((t) => {
        ...
        return (
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className={`relative flex items-center gap-3 px-3.5 py-3 rounded-2xl transition-all duration-300 shrink-0 cursor-pointer ${
              isActive
          ...
          >
            ...
            {t.id === "messages" && unreadCount > 0 && (
              <span className="ml-auto w-5 h-5 rounded-full bg-emerald-500 text-white text-[11px] font-bold flex items-center justify-center shadow-sm">
