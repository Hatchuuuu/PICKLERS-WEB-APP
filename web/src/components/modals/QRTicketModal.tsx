          ...
          <div className="bg-background/95 dark:bg-[#0d1527]/95 backdrop-blur-2xl border border-white/20 dark:border-white/[0.15] rounded-[26px] overflow-hidden shadow-[0_25px_70px_rgba(0,0,0,0.7)] flex flex-col max-h-full">
            ...
            <div className="px-4.5 py-3 border-b border-border dark:border-white/[0.1] flex items-center justify-between bg-surface-interactive/30 dark:bg-white/[0.04] backdrop-blur-md shrink-0">
              ...
              <button
                ...
                className="relative z-50 w-7.5 h-7.5 sm:w-8 sm:h-8 rounded-full flex items-center justify-center bg-black/20 dark:bg-white/15 hover:bg-black/40 dark:hover:bg-white/30 active:scale-90 transition-all text-foreground cursor-pointer shrink-0 pointer-events-auto"
            ...
            <div className="p-3.5 sm:p-5 flex flex-col items-center text-center overflow-y-auto hide-scrollbar">
              ...
              {(() => {
                ...
                return (
                  <div className="p-3 bg-white rounded-2xl shadow-xl border border-black/10 mb-2 flex flex-col items-center justify-center w-full max-w-[220px] sm:max-w-[240px]">
                    <div className="relative flex items-center justify-center bg-white p-0.5 rounded-xl">
                      {/* High-Contrast Low-Density Clean Vector QR Code */}
                      <QRCodeSVG
                        value={qrPayload}
                        size={190}
                        level="M"
                    ...
                    <div className="mt-2 font-mono text-[11px] font-extrabold text-slate-800 tracking-wider">
                      #{fullRef}
                    </div>
                  </div>
                );
              ...
              {/* Status Pill */}
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 sm:py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-black uppercase tracking-wider mb-1.5">
                <Ticket className="w-3 h-3" /> Verified Court Pass
              </div>

              {/* Clean Dashed Divider Line */}
              <div className="w-full border-t border-dashed border-border/60 dark:border-white/10 my-1.5" />

              {/* Reservation Details */}
              <h3 className="text-base sm:text-lg font-black text-foreground tracking-tight mb-0.5" style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
                {booking.court}
              </h3>
              ...
              <div className="flex gap-2.5 w-full mt-3">
                <button
                  type="button"
                  onClick={handleShare}
                  className="flex-1 py-2.5 rounded-xl font-bold text-xs sm:text-sm bg-secondary dark:bg-white/10 border border-border dark:border-white/10 text-foreground hover:bg-secondary/80 dark:hover:bg-white/15 transition-all flex items-center justify-center gap-1.5 active:scale-95 shadow-sm"
                >
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="flex-1 py-2.5 rounded-xl font-bold text-xs sm:text-sm text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 hover:bg-emerald-500/20 transition-all flex items-center justify-center gap-1.5 active:scale-95 shadow-sm"
                >
